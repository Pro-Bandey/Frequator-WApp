...
var BrowserDetect = {
  init: function () {
    ...
    if ("Explorer" == this.browser) {
      if (
        ((this.IE = !0), 8 >= this.majorVersion || 8 === document.documentMode)
      )
        this.IE8 = !0;
    } else
  ...
  searchVersion: function (a, c) {
    ...
    return -1 != (b = a.indexOf(c))
      ? parseFloat(a.substring(b + c.length + 1))
      : null;
  },
  dataBrowser: [
...
function setCookie(a, c, b, d) {
  ...
  document.cookie = a + "=" + encodeURIComponent(c) + d + b;
  cachedCookies && (cachedCookies[a] = c);
}
function loadCookies() {
  if (window.cachedCookies) return !1;
  window.cachedCookies = {};
  if (0 < document.cookie.length)
    for (var a = document.cookie.split("; "), c = 0; c < a.length; c++) {
      var b = a[c].indexOf("="),
        d = a[c].substring(0, b);
      cachedCookies[d] = decodeURIComponent(a[c].substring(b + 1));
    }
}
...
function deleteCookie(a, c) {
  void 0 === c && (c = "/");
  setCookie(a, "", c, -1);
  delete cachedCookies[a];
}
function writeCookieMessage(a, c, b) {
  getCookie("cOK") ||
    ((window.onCookieConsent = function () {
      document.getElementById("cookie-message").style.display = "none";
      setCookie("cOK", "y", "/", 730, !0);
      b && b();
    }),
    c || (c = "This site uses cookies. By using it, you agree to this."),
    document.write(
      "<div id=cookie-message>" +
        c +
        " <a href='" +
        a +
        "'>Learn more</a> <a href='javascript:void(0)' onclick='onCookieConsent()'>Got it</a></div>"
    ));
}
function DocumentClickTracker() {
  ...
  a.start = function (c, b, d) {
    ...
    void 0 !== document.ontouchstart &&
      (document.addEventListener("touchstart", a.onTouchStart, !0),
      document.addEventListener("touchmove", a.onTouchMove, !0),
      document.addEventListener("touchend", a.onTouchEnd, !0));
  };
  a.stop = function () {
    null !== a.callback &&
      ((a.callback = null),
      ...
      void 0 !== document.ontouchstart &&
        (document.removeEventListener("touchstart", a.onTouchStart, !0),
        document.removeEventListener("touchmove", a.onTouchMove, !0),
        document.removeEventListener("touchend", a.onTouchEnd, !0)));
  };
  a.reset = function () {
    a.mouseDownTarget = null;
  ...
  a.onTouchStart = function (c) {
    1 != c.touches.length || c.altKey || c.shiftKey || c.ctrlKey || c.metaKey
      ...
      : ((a.touchStartData.id = c.changedTouches[0].identifier),
        (a.touchStartData.target = c.target));
  };
  a.onTouchMove = function (c) {
    null !== a.touchStartData.id &&
...
function AdUnit(a, c, b) {
  var d = this,
    e = document.getElementById(a);
  if (!e) return !1;
  var f = e.querySelector("ins");
  if (!f) return !1;
  var g;
  d.id = a;
  d.size = c;
  ...
  d.enable = function () {
    d.removed || d.blocked || !g || (g.style.visibility = "hidden");
  };
  d.remove = function (h) {
    function l(n) {
      if ("opacity" == n.propertyName) {
        t.style.display = "block";
        e.style.height = Math.round(e.getBoundingClientRect().height) + "px";
        n = t.getBoundingClientRect().height;
        for (var r = e.childNodes.length - 1; 0 <= r; r--)
          e.childNodes[r] !== t && e.removeChild(e.childNodes[r]);
        e.removeEventListener("transitionend", l, !1);
        e.addEventListener("transitionend", m, !1);
        e.style.transition = "opacity 0.3s linear, height 0.3s linear";
        e.style.height = Math.ceil(n) + "px";
        e.style.opacity = "";
      }
    }
    function m(n) {
      "height" == n.propertyName &&
        ...
        b && b(),
        e.removeEventListener("transitionend", m, !1));
    }
    d.removed = !0;
    gtag("event", "ad_dismissed", {
      ad_id: d.id + (void 0 === d.size ? "" : "-" + d.size),
    });
    var p = d.id.lastIndexOf("-");
    void 0 !== h &&
      ((p = -1 < p ? d.id.slice(0, p) : d.id),
      setCookie("ab-" + encodeURIComponent(p), "y", "", h, !0));
    var t = e.querySelector(".ad-banner-remove-msg");
    e.addEventListener("transitionend", l, !1);
  ...
  d.reactToAdBlock = function () {
    if (!d.blocked) {
      ...
      var h = e.querySelector(".ad-banner-adblock-msg");
      h && (h.style.display = "block");
      e.style.height = "auto";
      if ((h = e.querySelector(".remove-ad-link")))
...
var adUnits = {
  ...
  add: function (a, c, b) {
    if (this.map.hasOwnProperty(a))
      throw "An ad unit with this id is already present";
    this.map[a] = new AdUnit(a, c, b && "function" == typeof b ? b : void 0);
  },
  getUnit: function (a) {
    return this.map[a];
  },
  disable: function () {
    for (var a in this.map) this.map[a].disable();
  },
  enable: function () {
    for (var a in this.map) this.map[a].enable();
  },
...
function PlayIndicator(a) {
  ...
  c.div = a;
  c.update = function () {
    c.div.className = tones.playing
      ? "playing " + window.waveType
      : "stopped " + window.waveType;
  };
}
function onPlayButtonClick() {
  tones.playing
    ? ((window.playButton.innerHTML = "Play"), tones.stop())
    : ((window.playButton.innerHTML = "Stop"),
      tones.play(window.sliderFreq, window.waveType));
...
function formatNumber(a) {
  ...
  if (1 == a.length)
    return (
      a[0].toLocaleString("en-US", { style: "currency", useGrouping: !0 }) +
      " <small>Hz</small>"
    );
  if (2 == a.length)
    return 2 >= a[1].length
      ? a[0].toLocaleString("en-US") + "<small>." + a[1] + " Hz</small>"
      : "<small>~&thinsp;</small>" +
          a[0].toLocaleString("en-US") +
          "<small>." +
          a[1].slice(0, 2) +
          " Hz</small>";
}
function separateThousands(a) {
  a = a.toString();
  for (var c = "", b = a.length - 1 - 2; 0 < b; b -= 3)
    c = "," + a.substr(b, 3) + c;
...
function formatHertz(a) {
  ...
  if (2 == a.length) {
    if (2 >= a[1].length)
      return separateThousands(a[0]) + "<small>." + a[1] + " Hz</small>";
    var c =
      "5" <= a[1].charAt(2) ? parseInt(a[1].slice(0, 2)) + 1 : a[1].slice(0, 2);
    return (
      "<small>~&thinsp;</small>" +
      separateThousands(a[0]) +
      "<small>." +
      c +
      " Hz</small>"
    );
...
function changeFreqBy1Hz(a) {
  1 == a
    ...
    : -1 == a && window.setFreq(Math.ceil(window.sliderFreq) + a);
}
function changeFreqByHundredthHz(a) {
  1 == a
    ? window.setFreq((Math.floor(100 * (window.sliderFreq + 1e-7)) + a) / 100)
    : -1 == a &&
      window.setFreq((Math.ceil(100 * (window.sliderFreq - 1e-7)) + a) / 100);
}
function changeFreqByThousandthHz(a) {
  1 == a
    ? window.setFreq((Math.floor(1e3 * (window.sliderFreq + 1e-7)) + a) / 1e3)
    : -1 == a &&
      window.setFreq((Math.ceil(1e3 * (window.sliderFreq - 1e-7)) + a) / 1e3);
}
function FrequencyReadout(a) {
  ...
  c.update = function (k) {
    k || (k = 3);
    var q = Math.floor(window.sliderFreq);
    0 < window.sliderFreq - q
      ? window.sliderFreq.toString().length <= q.toString().length + k + 1
        ? ((k = q.toString()),
          (g.nodeValue = separateThousands(k)),
          (h.nodeValue = window.sliderFreq.toString().slice(k.length)),
          (c.fractionOn = !0),
          (f.nodeValue = ""))
        : ((q =
            Math.round(window.sliderFreq * Math.pow(10, k)) / Math.pow(10, k)),
          (g.nodeValue = separateThousands(Math.floor(q).toString())),
          (h.nodeValue = q.toFixed(k).slice(-(k + 1))),
          (c.fractionOn = !0),
          (f.nodeValue = "~\u2009"),
          (c.tildeOn = !0))
      : ((g.nodeValue = separateThousands(q.toString())),
        c.fractionOn && (h.nodeValue = ""),
        c.tildeOn && (f.nodeValue = ""));
  };
  var p = function () {
    ...
    n = function (k) {
      if (!(k.shiftKey || k.ctrlKey || k.altKey || k.metaKey))
        switch (k.keyCode) {
          case 13:
            c.edit(), k.stopPropagation(), k.preventDefault();
        }
    },
    r = function (k) {
      p();
  ...
  c.closeEdit = function () {
    ...
    d.addEventListener("transitionend", function (k) {
      "opacity" == k.propertyName && c.destroyEdit();
    });
  };
  c.destroyEdit = function () {
    ...
    d = null;
    b.onclick = c.edit;
    b.addEventListener("keydown", n, !0);
    b.focus();
    e.stop();
  };
  b.onclick = c.edit;
...
function Dialog(a) {
  ...
  c.show = function (b, d, e) {
    ...
    if (d.fullscreen)
      if (
        ((b = c.div.getBoundingClientRect()),
        (f.left = Math.round((getViewportWidth() - b.width) / 2) + "px"),
        void 0 === d.fullscreenVertPoint || isNaN(d.fullscreenVertPoint))
      )
        f.top = Math.round((getViewportHeight() - b.height) / 2) + "px";
      else {
        g = getViewportHeight();
        const h = Math.min(b.height / 2 / g, 0.5);
        f.top =
          Math.round(
            g * Math.min(Math.max(d.fullscreenVertPoint, h), 1 - h) -
              b.height / 2
          ) + "px";
      }
  ...
  c.hide = function () {
    if (!c.div) return !1;
    c.div.addEventListener("transitionend", function (b) {
      "opacity" == b.propertyName && c.destroy();
    });
...
var noteSelectorWindow = {
    ...
    do {
      ...
      for (c; c < b && c <= MAX_PIANO_KEY; c++) {
        var e = document.createElement("td"),
          f = (c - FIRST_C + 12) % 12;
        if (1 == f || 3 == f || 6 == f || 8 == f || 10 == f)
          e.className = "halftone";
  ...
  onButtonClick: function (a) {
    noteSelectorWindow.selectedButton &&
      noteSelectorWindow.selectedButton.classList.remove("selected");
  ...
  show: function (a, c) {
    ...
    noteSelectorWindow.dialog.show &&
      ...
      noteSelectorWindow.dialog.show(
        noteSelectorWindow.panel,
        { closeButton: !0 },
        noteSelectorWindow.onDialogOutput
      ),
  ...
  highlightButton: function (a) {
    noteSelectorWindow.selectedButton &&
      noteSelectorWindow.selectedButton.classList.remove("selected");
    -1 != a &&
      (a = noteSelectorWindow.buttonArray[a]) &&
      (a.classList.add("selected"), (noteSelectorWindow.selectedButton = a));
  },
};
function NoteSelector(a, c) {
  ...
  b.updateFromFreq = function () {
    ...
    e < MIN_PIANO_KEY
      ...
      : e > MAX_PIANO_KEY
      ? ((b.buttonText.nodeValue = "above " + NOTE_NAMES[MAX_PIANO_KEY]),
        (b.tilde.nodeValue = ""))
      : ((b.buttonText.nodeValue = NOTE_NAMES[e]),
        (b.tilde.nodeValue = d == e ? "" : "~ "),
        b.windowShown && noteSelectorWindow.highlightButton(d == e ? d : -1));
  };
  b.displayKey = function (d) {
    b.buttonText.nodeValue = NOTE_NAMES[d];
    b.tilde.nodeValue = "";
  };
}
function DropDown(a) {
  ...
  c.show = function (b, d, e) {
    ...
    document.body.appendChild(c.div);
    c.div.appendChild(b);
    var l = c.div.getBoundingClientRect(),
      m = getViewportWidth();
    b = Math.round((g.left + g.right - l.width) / 2);
    5 > b && (b = 5);
    b + l.width > m - 20 && (b = m - l.width - 20);
...
function DropDownMenu(a) {
  ...
  c.show = function (b, d, e, f) {
    for (var g = document.createDocumentFragment(), h = 0; h < b.length; h++) {
      var l = b[h];
      l.onclick = c.onOptionClick;
      l.value == d && (l.classList.add("selected"), (c.selectedButton = l));
      g.appendChild(l);
    }
    c.callback = f;
    c.dropDown.show(g, e, f);
    c.dropDown.div.querySelector("button").focus();
  };
  c.onOptionClick = function (b) {
...
function WaveSelector(a, c) {
  ...
  e.push(a);
  b.onMenuOutput = function (g) {
    g === DropDown.DROPDOWN_CLOSE
      ? (b.button.classList.remove("control-shown"), (b.menuShown = !1))
      : c(g);
  };
  b.update = function () {
  ...
  b.button.onclick = function (g) {
    if (b.menuShown) return !1;
    g = new DropDownMenu("wave-selector-menu");
    g.show &&
      (g.show(e, b.value, this, b.onMenuOutput),
...
function BalanceControl(a, c) {
  ...
  b.onDropDownAction = function (d) {
    d === DropDown.DROPDOWN_CLOSE
      ? (b.button.classList.remove("control-shown"), (b.shown = !1))
      : c(d);
  };
  b.update = function (d) {
    void 0 === d && (d = !0);
    var e = Math.min(1, 1 - window.balance),
      f = Math.min(1, 1 + window.balance);
    b.LspeakerIcon &&
      (b.LspeakerIcon.style.opacity = Math.round(100 * e) / 100);
    b.RspeakerIcon &&
      (b.RspeakerIcon.style.opacity = Math.round(100 * f) / 100);
    b.shown &&
      ((b.readoutLeftVal.nodeValue = Math.round(100 * e) + "%"),
      (b.readoutRightVal.nodeValue = Math.round(100 * f) + "%"),
      d && $(b.sliderContainer).slider("value", window.balance));
  };
  b.button.onclick = function (d) {
    if (b.shown) return !1;
    ...
    e.className = "balance-button-section";
    ...
    f.value = "L";
    f.title = "Left";
    f.tabIndex = b.button.tabIndex + 1;
    g.innerHTML = "C";
    g.value = "C";
    g.title = "Center";
    g.tabIndex = b.button.tabIndex + 2;
    h.innerHTML = "R";
    h.value = "R";
    h.title = "Right";
    h.tabIndex = b.button.tabIndex + 3;
    f.onclick = g.onclick = h.onclick = b.onLCRButtonClick;
    e.appendChild(f);
    e.appendChild(g);
    e.appendChild(h);
    d.appendChild(e);
    e = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    e.setAttribute("class", "speaker-icon");
    e.id = "left-speaker-icon";
    f = document.createElementNS("http://www.w3.org/2000/svg", "use");
    f.setAttributeNS(
    ...
    d.appendChild(b.sliderContainer);
    e = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    e.setAttribute("class", "speaker-icon");
    e.id = "right-speaker-icon";
    f = document.createElementNS("http://www.w3.org/2000/svg", "use");
    f.setAttributeNS(
      "http://www.w3.org/1999/xlink",
      "href",
    ...
    e.className = "balance-readout";
    f = document.createElement("div");
    g = document.createElement("span");
    b.readoutLeftVal = document.createTextNode("");
    g.appendChild(b.readoutLeftVal);
    ...
    $(b.sliderContainer).slider({
      ...
      step: 0.01,
      slide: function (l, m) {
        window.setBalance(m.value, !1);
      },
      stop: function (l, m) {},
    });
    b.sliderContainer.querySelector(".ui-slider-handle").tabIndex =
      b.button.tabIndex + 4;
    b.shown = !0;
    b.update();
    b.dropDown.show(d, this, b.onDropDownAction);
    b.dropDown.div.querySelector("button").focus();
    b.button.classList.add("control-shown");
  };
  b.onLCRButtonClick = function (d) {
    ...
    switch (a.keyCode) {
      case 37:
        if (
          ...
          a.target.parentNode != window.slider
        )
          break;
        a.preventDefault();
        a.stopPropagation();
...
function UpDownButton(a, c) {
  ...
  this.button.onmousedown = function (d) {
    b.timeoutID ||
      ...
      window.addEventListener("mouseup", b.onMouseUp, !0));
  };
  ...
  this.button.onkeydown = function (d) {
    if (
      !(
        b.timeoutID ||
        b.intervalID ||
      ...
      switch (d.keyCode) {
        case 13:
          b.action(), d.preventDefault(), d.stopPropagation();
      }
  };
}
function parseHash(a) {
  ...
  if ("" != a) {
    a = a.split(",");
    for (let h of a)
      if (/^\d+\.?\d*$/.test(h) && void 0 === e && void 0 === f)
        var e = parseFloat(h);
      else if (/^[A-G]s?\d$/.test(h) && void 0 === f && void 0 === e) {
        h = h.replace("s", "\u266f");
        var f = NOTE_NAMES.findIndex(function (l) {
          return h == l.substr(0, h.length);
        });
      } else if (void 0 === g && (d = /^(squ|saw|tri|sin)/.exec(h)))
        switch (d[0]) {
          case "squ":
            var g = "square";
            break;
        ...
        void 0 === c && /^v\d\.?\d*$/.test(h)
          ? (c = parseFloat(h.substr(1)))
          : void 0 === b &&
            /^b-?\d\.?\d*$/.test(h) &&
            (b = parseFloat(h.substr(1)));
  }
  if (void 0 === e)
    e = void 0 !== f && -1 != f ? 440 * Math.pow(2, (f - 49) / 12) : 440;
  else if (e < MIN_FREQ || e > MAX_FREQ) e = 440;
  void 0 === g && (g = "sine");
  if (void 0 === c || 0 > c || 1 < c) c = DEFAULT_VOLUME;
  if (void 0 === b || -1 > b || 1 < b) b = 0;
  return { freq: e, type: g, vol: c, bal: b };
}
function getShortURL() {
  ...
  return window.location.protocol + "//" + a + "/Frequator-WApp/#" + constructHash();
}
function constructHash() {
  var a = 12 * Math.log2(window.sliderFreq / 440) + 49;
  0 == a % 1 && a >= MIN_PIANO_KEY && a <= MAX_PIANO_KEY
    ? ((a = /^\w\u266f?\d/.exec(NOTE_NAMES[a])),
      (a = null !== a ? a[0].replace("\u266f", "s") : window.sliderFreq))
    : (a = window.sliderFreq);
...
function Tone(a, c) {
  ...
  b.play = function (d) {
    void 0 === d && (d = a.currentTime);
    if (b.oscillatorStopTimeoutID)
      clearTimeout(b.oscillatorStopTimeoutID),
        (b.oscillatorStopTimeoutID = null);
    else {
      if (b.playing) return !1;
      b.initOscillator();
      b.oscillator.start(d);
    }
    BrowserDetect.Firefox
      ? b.fadeGainNode.gain.setTargetAtTime(1, d, FADE_SET_TARGET_TIME_CONSTANT)
      : (b.fadeGainNode.gain.cancelScheduledValues(d),
        b.fadeGainNode.gain.setValueAtTime(b.fadeGainNode.gain.value, d),
        b.fadeGainNode.gain.linearRampToValueAtTime(
          1,
          d + FADE_TIME * (1 - b.fadeGainNode.gain.value)
        ));
    b.playing = !0;
  };
  b.stop = function (d) {
    ...
    if (BrowserDetect.Firefox)
      b.fadeGainNode.gain.setTargetAtTime(0, d, FADE_SET_TARGET_TIME_CONSTANT),
        (d = 1e3 * (d - a.currentTime + 8 * FADE_SET_TARGET_TIME_CONSTANT));
    else {
      b.fadeGainNode.gain.cancelScheduledValues(d);
      b.fadeGainNode.gain.setValueAtTime(b.fadeGainNode.gain.value, d);
      var e = FADE_TIME * b.fadeGainNode.gain.value;
      b.fadeGainNode.gain.linearRampToValueAtTime(0, d + e);
      d = 1e3 * (d - a.currentTime + e + 0.5);
    }
  ...
  b.setFreq = function (d) {
    b.freq = d;
    b.playing && b.oscillator.frequency.setTargetAtTime(d, a.currentTime, 0.03);
  };
  b.setType = function (d) {
    b.type = d;
    b.playing && (b.oscillator.type = d);
  };
  b.setBalance = function (d) {
    if (2 !== b.channels) return !1;
    b.balance = d;
    b.playing
      ? (b.leftGainNode.gain.setTargetAtTime(
          Math.min(1, 1 - d),
          a.currentTime,
          FADE_SET_TARGET_TIME_CONSTANT
        ),
        b.rightGainNode.gain.setTargetAtTime(
          Math.min(1, 1 + d),
          a.currentTime,
          FADE_SET_TARGET_TIME_CONSTANT
        ))
      : (b.leftGainNode.gain.setValueAtTime(Math.min(1, 1 - d), a.currentTime),
        b.rightGainNode.gain.setValueAtTime(Math.min(1, 1 + d), a.currentTime));
  };
  b.setVolume = function (d) {
    b.playing
      ? b.gainNode.gain.setTargetAtTime(
          d,
          a.currentTime,
          FADE_SET_TARGET_TIME_CONSTANT
        )
      : b.gainNode.gain.setValueAtTime(d, a.currentTime);
    b.volume = d;
  };
}
var tones = {
  ...
  init: function () {
    if (window.AudioContext) tones.context = new AudioContext();
      ...
      tones.context = new webkitAudioContext();
  ...
  remove: function (a) {
    ...
    for (a += 1; a < tones.array[length]; a++)
      tones.array[a - 1] = tones.array[a];
    --tones.array.length;
  },
  select: function (a) {
    if (!tones.array[a]) return !1;
...
function init() {
  ...
  $("#slider").slider({
    ...
    step: 1,
    slide: function (b, d) {
      window.sliderFreq = sliderPosToFreq(d.value);
      window.freqReadout.update();
      updateAriaValue();
      window.noteSelector.updateFromFreq();
      tones.current.setFreq(window.sliderFreq);
  ...
  sliderHandle &&
    ((sliderHandle.tabIndex = 20), sliderHandle.setAttribute("role", "slider"));
  if ((a = document.querySelector("#volume-slider .ui-slider-handle")))
    a.tabIndex = 30;
  ...
  window.noteSelector = new NoteSelector(
    document.getElementById("note-selector"),
    window.setKey
  );
  window.waveSelector = new WaveSelector(
    document.getElementById("wave-selector"),
    window.setWaveType
  );
  window.getLinkButton = document.getElementById("get-link");
  window.getLinkButton.onclick = function () {
    var b = new DropDown("notice");
    navigator.clipboard.writeText(getShortURL()).then(
      function () {
        b.show(
          document.createTextNode("Link to current tone copied"),
          window.getLinkButton
        );
      },
      function () {
        b.show(
          document.createTextNode("Error: Could not copy link to clipboard"),
          window.getLinkButton
        );
      }
    );
...
function onLoad() {
  AD_FREE || adUnits.checkIfAdsLoaded();
}
